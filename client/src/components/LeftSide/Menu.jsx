...
function Menu() {
    ...
    return (
        <>
            <div class="menu mt-8">
                <Link to="/personal" class="flex items-center justify-center py-4 px-4 border-l-4 text-gray-100 hover:bg-[#2D3748]">
                ...
                <Link to="/group" class="flex items-center justify-center py-4 px-4 border-l-4 border-gray-800 bg-blue-700 text-black">
                    <span class="inline-block align-text-bottom">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <MyProfileModal show={show} setShow={setShow}/>
        </>
    )
}
