            ...
            <div className="bg-[#1A202C] w-50 overflow-hidden shadow-xl transform transition-all max-w-3xl mx-auto">
                <div className="p-6">
                    ...
                    <div className="flex justify-end mt-6">
                        {checkedUsers.length>1 && <input onChange={(e)=>{setGroupName(e.target.value)}}  type="text" className="border rounded px-2 py-1" placeholder="Enter Group Name" />}
                        <button onClick={onClose} className="bg-gray-500 hover:bg-gray-600 text-white font-semibold px-4 py-2 mr-4 rounded">Close</button>
