...
export default function CreateChatModal({ isOpen, onClose }) {
    ...
    const handleCreateChat = () => {
        if (checkedUsers.length > 1 && !groupName) {
            return toast("Enter the group name");
        }
                    ...
                    {checkedUsers.length > 1 &&
                        ...
                        <>
                            ...
                            <input
                                ...
                                type="text"
                                className="transform hover:scale-105 duration-100 transition-transform mb-4 rounded p-4 flex text-black border border-gray-300 focus:outline-none focus:border-blue-500"
